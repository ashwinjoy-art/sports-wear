    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            Discover the perfect blend of style and functionality in our premium
            sportswear collection. Engineered for peak performance, each item is
            crafted to support your every move, no matter the intensity of your
            workout. Our selection features breathable fabrics and ergonomic
            designs tailored for athletes and fitness enthusiasts alike. With
            our apparel, you'll not only look great but also feel empowered to
            achieve your goals. Redefine your active wardrobe and embrace your
            fitness journey today!.
          </p>
          <p>
            Unleash your potential with our expertly crafted sportswear that
            supports every movement. From breathable fabrics to ergonomic
            designs, our apparel is tailored for optimal performance and
            flexibility. Ideal for athletes and casual enthusiasts alike, our
            collection keeps you motivated and focused on your goals. Shop now
            to redefine your active wardrobe!
          </p>
        </div>
      </div>
